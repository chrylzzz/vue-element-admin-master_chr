...
// api返回路由信息
// const { routesInfo } = await store.dispatch('getScore/getasyncRoutesInfo')
// debugger
/**
 * 需要验证权限的路由地址,角色控制路由
 * 
...
export const asyncRoutes = [
  {
    ...
    alwaysShow: true, // will always show the root menu , 该设置
    name: 'Permission',
    meta: {
      title: 'Permission',
      icon: 'lock',
...
//实例化vue的时候只挂在constantRoutes通用页面
